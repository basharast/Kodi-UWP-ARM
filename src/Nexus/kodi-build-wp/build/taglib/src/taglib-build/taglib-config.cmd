...
:doit
if /i "%1#" == "--libs#"    echo -LC:/kodi/project/BuildDependencies/win10-arm/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/kodi/project/BuildDependencies/win10-arm/include -IC:/kodi/project/BuildDependencies/win10-arm/include/taglib
if /i "%1#" == "--version#" echo 1.13
if /i "%1#" == "--prefix#"  echo C:/kodi/project/BuildDependencies/win10-arm
