...
namespace PythonBindings
{
  ...
  PyObject *PyInit_Module_xbmcplugin()
  {
   ...
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_ORIGINAL_TITLE",SORT_METHOD_VIDEO_ORIGINAL_TITLE); 
   PyModule_AddIntConstant(module,"SORT_METHOD_VIDEO_ORIGINAL_TITLE_IGNORE_THE",SORT_METHOD_VIDEO_ORIGINAL_TITLE_IGNORE_THE); 
