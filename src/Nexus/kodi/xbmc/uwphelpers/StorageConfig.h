...
#define APPEND_DOCUMENTS_LOCATION 1 // (requires 'documentsLibrary' capability)
#define APPEND_VIDEOS_LOCATION 1 // (requires 'videosLibrary' capability)
#define APPEND_MUSIC_LOCATION 1 // (requires musicLibrary' capability)
#define APPEND_PICTURES_LOCATION 1 // (requires 'picturesLibrary' capability)
