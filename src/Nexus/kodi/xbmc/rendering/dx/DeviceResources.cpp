...
void DX::DeviceResources::CreateDeviceResources()
{
  ...
  bool force93 = CServiceBroker::GetSettingsComponent()->GetSettings()->GetBool(
      CSettings::SETTING_VIDEOSCREEN_FORCEFL93);
...
#else
    swapChainDesc.BufferCount = 2; // Xbox don't like 6 backbuffers (3 is fine even for 4K 60 fps)
#endif
...
{
  float scaleFactor = 1.5f; // Increase this factor to lower the quality more
...
void DX::DeviceResources::SetWindowPos(winrt::Rect rect)
{
  ...
  HandleOutputChange(
      [centerX, centerY](DXGI_OUTPUT_DESC outputDesc)
      {
